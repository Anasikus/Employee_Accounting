...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 12 2024 г., 07:37
...
INSERT INTO `employeeAccounting` (`idRecords`, `idEmployee`, `idPersonalData`, `idDepartment`, `idPost`, `idStatus`, `hourlyRate`) VALUES
(1, 1, 1, 1, 1, 2, 360),
(2, 2, 2, 2, 2, 1, 280);
...
INSERT INTO `personalData` (`idPersonalData`, `passportData`, `passportSeries`, `passportNumber`, `addressResidential`, `email`, `phoneNumber`) VALUES
(1, 0, 2312, 455344, 'Улица Первомайская. 45Д', 'AlekseyKorshunov@mail.ru', '89033221553'),
(2, 0, 2832, 123221, 'Улица Свободы, д. 43', 'IvanEgorov@gmail.com', '88005553535');
...
INSERT INTO `Post` (`idPost`, `titlePost`) VALUES
(1, 'Тестировщик'),
(2, 'Web-дизайнер'),
...
--
ALTER TABLE `Employee`
  MODIFY `idEmployee` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT для таблицы `employeeAccounting`
--
ALTER TABLE `employeeAccounting`
  MODIFY `idRecords` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;

--
-- AUTO_INCREMENT для таблицы `personalData`
--
ALTER TABLE `personalData`
  MODIFY `idPersonalData` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
